						...
						<div class="product well">
							...
							<div class="col-md-9">
								<div class="caption">
									...
									<div>
										<input type="submit" name="update" style="margin-top:31px" value="Cập nhật lại số lượng sách" class="btn btn-2" />
									</div>
									<hr>
									<input type="submit" name="remove" value="Xóa khỏi giỏ hàng" class="btn btn-2" />
									<input type="hidden" name="idsprm" value="<?php echo $s["ID"] ?>" />
									<hr>
									<?php
									if ($s["KhuyenMai"] == true) {
									?>
										<label style="color:blue">Thành tiền: <?php ;
