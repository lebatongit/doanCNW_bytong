		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-6">
					...
					<select class="form-control select2" multiple="multiple" name="dichvu" id="dichvu" onchange="laygiatheoiddichvu(this.value)" data-placeholder="Vui lòng chọn dịch vụ ">
						<?php
